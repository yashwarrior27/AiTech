            ...
            <table class="table table-striped  table-hover table-borderless pt-3" id="myTable">
                <thead class="">
                  <tr>
                    ...
                    <th scope="col" class="text-center"> Reward Business</th>
                ...
                <tbody>
                    ...
                    <tr><th class="d-none">{{$item->id??'-'}}</th>
                        ...
                        <td class="text-center">{{'$ '.$item->rewardIncome->total_business??'-'}}</td>
                        <td class="text-center">{{$item->user->register_id??'-'}}</td>
                        <td class="text-center">{{'$ '.$item->rewardIncome->reward_amount??'-'}}</td>
